...
| `linelimit` | Optional | *integer* | `800` | Maximum pixels per line (row) |
...
Draw the glyphs of the specified words / setences / paragraphs (as a *string*), to a *Bitmap* object
