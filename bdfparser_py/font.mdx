...
| `missing` | Optional | *dictionary* or [*Glyph*](glyph) object | An empty glyph with hexdata `[]` and metrics all `0` | The missing glyphs will be replaced by this one. It can be a *dictionary* of glyph meta information, or a [*Glyph*](glyph) object |
