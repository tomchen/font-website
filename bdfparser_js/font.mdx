...
import filelines from 'bdfparser/filelines/nodefs' // or 'bdfparser/filelines/fetch' for browsers
(async () => {
...
| :-- |:-- | :-- | :-- | :-- |
| `filelines` | Required | *AsyncIterableIterator* | *N/A* | Asynchronous iterable iterator representing each line in string text from the font file. You can use `bdfparser/filelines/nodefs` for node file system or `bdfparser/filelines/fetch` for browsers. See the above example |
